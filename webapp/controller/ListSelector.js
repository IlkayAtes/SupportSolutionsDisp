sap.ui.define([
		...
		return BaseObject.extend("supportsolutionsdisp.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias supportsolutionsdisp.model.ListSelector
			 */
			 ...
			 * @return {supportsolutionsdisp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
